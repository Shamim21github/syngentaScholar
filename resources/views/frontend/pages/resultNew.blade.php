...
<body>
  <div class="container">
    <header>
      ...
      <nav class="nav-links">
        <ul>
            ...
            <li><a href="{{ route('result') }}" style="font-weight: bold">Result</a></li>
    ...
    <div class="image-container">
      ...
      <img src="{{ asset('frontend/assets/images/final/resutlNew.png') }}" alt="header image" class="full-page-image">
    </div>
  </div>
